...
- context7 → Official Go library documentation lookup
- exa → Production Go code examples, web search
...
| Compilation error | Show compiler output | Isolate failing package |
...
| New golangci-lint rule | Add to Quality Gate Go-Specific Checks |
-->
